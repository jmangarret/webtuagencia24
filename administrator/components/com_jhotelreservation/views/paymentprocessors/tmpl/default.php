...
<form action="<?php echo JRoute::_('index.php?option=com_jhotelreservation&view=paymentprocessors');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped adminlist"  id="itemList">
		<thead>
			<tr>
				...
				<th width='30%' ><?php echo JText::_('LNG_CONFIGURATION',true); ?></th>	
				<th nowrap="nowrap" width="25%" class="nowrap">
				...
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_DISPLAY_FRONT', 'p.displayfront', $listDirn, $listOrder); ?></th>
				<th width='10%' ><?php echo JHtml::_('grid.sort', 'LNG_STATUS', 'p.status', $listDirn, $listOrder); ?></th>
				<th nowrap="nowrap" width='1%' ><?php echo JHtml::_('grid.sort', 'LNG_ID', 'p.id', $listDirn, $listOrder); ?></th>
			</tr>
		</thead>
		<tfoot>
				<tr>
		...
		<tbody>
			...
			>
				...
				<TD align=center>
					...
					<TD align=left>
						<a
							href='<?php echo JRoute::_( 'index.php?option=com_jhotelreservation&task=paymentprocessor.edit&id='. $item->id )?>'
					...
					<td align=center>
							<img src ="<?php echo JURI::base() ."components/".getBookingExtName()."/assets/img/".($item->displayfront==0? "unchecked.gif" : "checked.gif")?>" 
								onclick	="document.location.href = '<?php echo JRoute::_( 'index.php?option=com_jhotelreservation&task=paymentprocessors.changeFrontState&id='. $item->id )?>'"
							/>
					</td>
				
					<td align=center>
							<img src ="<?php echo JURI::base() ."components/".getBookingExtName()."/assets/img/".($item->status==0? "unchecked.gif" : "checked.gif")?>" 
								onclick	="document.location.href = '<?php echo JRoute::_( 'index.php?option=com_jhotelreservation&task=paymentprocessors.changeState&id='. $item->id )?>'"
							/>
					</td>
