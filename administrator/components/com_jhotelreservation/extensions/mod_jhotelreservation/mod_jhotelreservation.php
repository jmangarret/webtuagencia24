...
JHTML::_('stylesheet', 	'components/com_jhotelreservation/assets/css/form.css');
JHTML::_('stylesheet', 	'components/com_jhotelreservation/assets/css/joomlacalendar.css');
JHTML::_('stylesheet', 	'components/com_jhotelreservation/assets/css/responsive.css');
