						...
						<table width="500px" cellspacing="2" cellpadding="2">
							...
							<tr style="background-color: #F2F2F2;">
								...
								<td
									...
									width="250"><?php echo JText::_("CP.PLAN.NUMBER.NIGHTS")?>
								</td>
								<td
									style="color: #4A4A4A; font-weight: bold; padding: 2px 2px 2px 4px; padding-right: 10px; width: 130px;"><?php echo JText::_("CP.QUOTE.ADULTS")?>
								</td>
							</tr>
							...
							<tr style="background-color: #F2F2F2;">
								<td
									style="color: #4A4A4A; font-weight: bold; padding: 2px 2px 2px 4px; padding-right: 10px; width: 130px;"><?php echo JText::_("CP.QUOTE.CHILDS")?>
								</td>
								<td
									style="color: #4A4A4A; font-weight: bold; padding: 2px 2px 2px 4px;"><?php echo JText::_("CP.QUOTE.CITY")?>
								</td>
								<td
									style="color: #4A4A4A; font-weight: bold; padding: 2px 2px 2px 4px;"></td>
							</tr>

							<tr style="background-color: #F9F9F9;">
								<td style="padding: 2px 2px 2px 4px;">{childs}</td>
								<td style="padding: 2px 2px 2px 4px;">{city}</td>
								<td style="padding: 2px 2px 2px 4px;"></td>
							</tr>
