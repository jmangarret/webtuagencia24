				...
				<TABLE class="adminlist" >
					...
					>
						...
						<TD valign=top align=center>
							...
							<?php echo $package->package_datas!='0000-00-00' ? getDateGeneralFormat($package->package_datas) : str_repeat('&nbsp;',10)?>
							<?php echo $package->package_datas!='0000-00-00' ||  $package->package_datae!='0000-00-00' ? '&nbsp;&nbsp;'. JText::_('LNG_TO',true) .'&nbsp;&nbsp;'  : ' '?>
							<?php echo $package->package_datae!='0000-00-00' ? getDateGeneralFormat($package->package_datae) : str_repeat('&nbsp;',10)?>
						</TD>
