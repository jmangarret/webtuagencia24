				...
				Titulo original del buscador de hoteles-->
					...
					<?php if ($params->get('show-search')==1){?>
						<div class="destination divider">
							...
							<div id="div_mapa"><a href="javascript:void(0)" id="show_hotels_map"><?php //echo JText::_('LNG_SHOW_HOTELS_MAP',true)?> Mostrar el Mapa de los Hoteles</a></div>
								<label>
								<!--micod-->
								...
								<?php foreach ($datos_hoteles as $key => $value) {
									?>
										<option value="<?php echo $value->hotel_name; ?>"><?php echo $value->hotel_name."   -   ".$value->hotel_address; ?></option>
								<?php	
								}
								?>
					...
					<div class="rooms divider row-fluid">
						...
						<div class="span4">
						<!--micod
						Eliminar "Invitado" y cambiarlo a "Invitados"-->
					...
					<?php } ?>
					<div id="div_del_boton_verificar">
					<!--micod
					Cambiar el nombre del botón a "Buscar"-->
