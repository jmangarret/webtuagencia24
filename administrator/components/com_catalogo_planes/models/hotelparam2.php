 ...
 *
 * @version $Id: hotelparam2.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelHotelParam2 extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		$this->_filter_prefix = $option . '_hotelparam2';
    }
	...
	public function getOrderByField() {
		...
		if (!in_array($filter_order, array('param2_id', 'param2_name', 'capacity', 'published'))) {
    ...
    public function getRelatedProducts ($id) {
        $query = 'SELECT a.product_id, a.product_name FROM #__cp_hotels_param2 b JOIN #__cp_hotels_info a ' . 
