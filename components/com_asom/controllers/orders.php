...
function displayPdfProduct() {
    ...
    function sendMailAir($id) {
        ...
        //Instantiate model
   		$orderObject = $model->setOrderID($id);
		...
		if(count($vuelo) > 1){
			...
			foreach($vuelo as $vuelo1){
				...
				$intinerario.="<td>".$vuelo1->OperatingAirline['CompanyShortName']."</td>";
				$intinerario.="<td>".$vuelo1['FlightNumber']."</td>";
				$intinerario.="<td>".$vuelo1['StopQuantity']."</td>";
				$intinerario.="<td>".$vuelo1->BookingClassAvails['CabinType']."</td></tr>";
		...
		$intinerario.="<td>".$infoDep."</td>";
		$intinerario.="<td>".$infoArr."</td>";
		$intinerario.="<td>".$vuelo->FlightSegment->OperatingAirline['CompanyShortName']."</td>";
		$intinerario.="<td>".$vuelo->FlightSegment['FlightNumber']."</td>";
		$intinerario.="<td>".$vuelo->FlightSegment['StopQuantity']."</td>";
		$intinerario.="<td>".$vuelo->FlightSegment->BookingClassAvails['CabinType']."</td></tr>";
		$arrayItinerary[] = $intinerario;
		}
