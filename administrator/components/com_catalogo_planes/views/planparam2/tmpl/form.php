...
Joomla.submitbutton = function(pressbutton) {
        ...
        if (jQuery.trim(form.param2_name.value) == "") {
            alert("<?php echo JText::_('CP.PLANPARAM2_ERROR_EMPTY_NAME', true); ?>");
        } else if (parseInt(form.capacity.value, 10) < 1) {
            alert("<?php echo JText::_('CP.PLANPARAM2_ERROR_EMPTY_CAPACITY', true); ?>");
        } else {
            submitform(pressbutton);
        }
	}
...
?>
		<table class="admintable">
			<tr>
				<td align="right" class="key">
					<label for="param2_name">
						<?php echo JText::_('CP.PLANPARAM2_NAME'); ?>: *
					</label>
				</td>
				<td>
			...
			<tr>
				<td align="right" class="key">
					<label for="capacity">
						<?php echo JText::_('CP.PLANPARAM2_CAPACITY'); ?>: *
					</label>
				</td>
				<td>
                    <?php
