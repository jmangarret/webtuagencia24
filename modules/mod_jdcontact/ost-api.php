<?php
  ...
  class ost_api
  {
    ...
    public static function send_ost_api($name,$email,$phone,$message,$valores)
    {
      ...
      $config = array(
      'url'=>'http://humbermarccs.dyndns.tv:8080/ostickets/upload/api/http.php/tickets.json',  // URL to site.tld/api/tickets.json //Antes era -> http://your.domain.tld/api/tickets.json
      'key'=>'E42496B2FA37DB38A6E654A94A6D81C0'  // API Key goes here //PUTyourAPIkeyHERE
      );
      ...
      'valores'   =>      $valores,  // test ticket body, aka Issue Details.
      ...
      //SE CAPTURA EL NUMERO DEL TICKET
      $ticket_number = $result;

      //SE RETORNA EL NUMERO DEL TICKET
