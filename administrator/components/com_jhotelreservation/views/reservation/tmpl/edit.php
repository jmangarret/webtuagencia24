...
<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_jhotelreservation&view=reservation&layout=edit'); ?>" method="post"  class="form-horizontal">
	...
	<fieldset class="adminform reservation reservation-box">
		...
		<!--micod
		Agregar un nuevo campo para el nombre del hotel en las reservas del administrator-->
		<tr>
				<td width=10% nowrap class="key"> Hotel </td>
				<td>
					<?php 
						echo $this->item->reservationData->hotel->hotel_name
					?>
				</td>
			</tr>
			<tr>
			...
			<!--micod
			Quitar el campo VALE de las reservas del administrator-->
			<!--<tr>
	...
	<fieldset class="adminform reservation reservation-box">
		...
		<TABLE class="admintable">
		<!--micod
		Quitar los Checkboxs de tipo de persona de las reservas del administrator-->
			<!--<tr>
				<td class="key">
			...
			<!--micod
		Quitar el campo Código Postal de las reservas del administrator-->
			<!--<tr>
			...
			<!--micod
		Quitar el campo Estado de las reservas del administrator-->
			<!--<tr>
			...
			<?php
			$edades = explode("|", $this->item->reservationData->userData->child_age);
			$niños=0;
	...
	<fieldset class="adminform reservation left" id="reservation-rooms">
		...
		<div class="persons">
			...
			<select name="adults" id="adults">
				<?php for($i=0; $i<=4;$i++){?>
					<option	value="<?php echo $i?>" <?php echo $i==$this->item->reservationData->userData->adults ?'selected="selected"':''?>><?php echo $i?></option>
				<?php } ?>
			</select>
			<div style="">
			...
			<?php echo JText::_('LNG_JUNIORS',true)?>: 
			 <select name="children" id="children">
			 	<?php for($i=0; $i<=4;$i++){?>
					<option	value="<?php echo $i?>" <?php echo $i==$this->item->reservationData->userData->total_children ?'selected="selected"':''?> ><?php echo $i?></option>
				<?php } ?>
			</select> 
			<?php } ?>
			</div>
			...
			<!--////////////////////////////////////////////////////////////////////////-->
						...
						jQuery.noConflict();
								jQuery(document).ready(function(){
							            ...
							            if(jQuery('select[name=children]').val() == 0){
											jQuery("#edades").css("display","none");
										}else if(jQuery('select[name=children]').val() == 1){
											jQuery("#edades").css("display","inline");
											jQuery("#edad-1").css("display","inline");
											jQuery("#edad-2").css("display","none");
											jQuery("#edad-3").css("display","none");
											jQuery("#edad-4").css("display","none");
											jQuery("#edad-5").css("display","none");
											jQuery("#edad-6").css("display","none");
										}else if (jQuery('select[name=children]').val() == 2) {
											jQuery("#edades").css("display","inline");
											jQuery("#edad-1").css("display","inline");
											jQuery("#edad-2").css("display","inline");
											jQuery("#edad-3").css("display","none");
											jQuery("#edad-4").css("display","none");
											jQuery("#edad-5").css("display","none");
											jQuery("#edad-6").css("display","none");
										}else if (jQuery('select[name=children]').val() == 3) {
											jQuery("#edades").css("display","inline");
											jQuery("#edad-1").css("display","inline");
											jQuery("#edad-2").css("display","inline");
											jQuery("#edad-3").css("display","inline");
											jQuery("#edad-4").css("display","none");
											jQuery("#edad-5").css("display","none");
											jQuery("#edad-6").css("display","none");
										}else if (jQuery('select[name=children]').val() == 4) {
											jQuery("#edades").css("display","inline");
											jQuery("#edad-1").css("display","inline");
											jQuery("#edad-2").css("display","inline");
											jQuery("#edad-3").css("display","inline");
											jQuery("#edad-4").css("display","inline");
											jQuery("#edad-5").css("display","none");
											jQuery("#edad-6").css("display","none");
										}else if (jQuery('select[name=children]').val() == 5) {
											jQuery("#edades").css("display","inline");
											jQuery("#edad-1").css("display","inline");
											jQuery("#edad-2").css("display","inline");
											jQuery("#edad-3").css("display","inline");
											jQuery("#edad-4").css("display","inline");
											jQuery("#edad-5").css("display","inline");
											jQuery("#edad-6").css("display","none");
										}else if (jQuery('select[name=children]').val() == 6) {
											jQuery("#edades").css("display","inline");
											jQuery("#edad-1").css("display","inline");
											jQuery("#edad-2").css("display","inline");
											jQuery("#edad-3").css("display","inline");
											jQuery("#edad-4").css("display","inline");
											jQuery("#edad-5").css("display","inline");
											jQuery("#edad-6").css("display","inline");
										}


								jQuery("select[name=children]").change(function(){
										if(jQuery('select[name=children]').val() == 0){
											jQuery("#edades").css("display","none");
										}else if(jQuery('select[name=children]').val() == 1){
											jQuery("#edades").css("display","inline");
						...
						<div id="edades" style="display: none;">
			...
			<div>
				...
				<div class="nights">
					<ul>
						...
						?>
						<li>
							<?php echo $dayString?>: <input type="text"	name="roomdetails[<?php echo $room->offer_id."|".$room->room_id."|".$room->current?>][price][<?php echo $dayString?>]" id="room_price_<?php echo $room->id?>_<?php echo $dayString?>" onBlur="setCustomPrice()" value="<?php echo $price?>" <?php if(!isSuperUser(JFactory::getUser()->id)) echo "disabled";?>>
