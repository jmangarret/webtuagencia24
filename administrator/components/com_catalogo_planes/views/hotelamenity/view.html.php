...
class CatalogoPlanesViewHotelAmenity extends JView {
    ...
    function display ($tpl = null) {
        ...
        if ($layout == 'form') {
            ...
            $ultimo=$component->get('params');
            $this->hotelamenity_image_folder =$ultimo->cfg_hotelamenity_image_folder;
            ...
            // Obtiene título de la interfaz
            $title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.HOTELAMENITY');
        }
