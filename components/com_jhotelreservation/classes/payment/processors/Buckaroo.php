...
class Buckaroo implements IPaymentProcessor {
	...
	public function initialize($data){
		...
		$this->name =  $data->name;
		$this->mode = $data->mode;
		$this->secretKey = $data->fields["secretKey"];
		$this->merchantId = $data->fields["merchantId"];
	...
	public function getPaymentProcessorHtml(){
		...
		<li>
		".JText::_('LNG_PROCESSOR_BUCKAROO',true)."
		</li>
		</ul>";
	...
	public function processResponse($params){
		...
		$result->confirmation_id =$params["brq_invoicenumber"];
