									...
									<table width="100%" border="0" cellspacing="2" cellpadding="4"
										...
										<tr
											...
											<td align="left" valign="top"
												style="width: 180px; padding-top: 8px; padding-bottom: 8px;"><?php echo JText::_("CP.CAR.DATE.CHECKIN")?>
											</td>
											<td align="left" valign="top" style="width: 180px;"><?php echo JText::_("CP.CAR.DATE.CHECKOUT")?>
											</td>
											<td align="left" valign="top" style="width: 180px;"><?php echo JText::_("CP.QUOTE.DURATION")?>
											</td>
										</tr>
										<tr>
											<td align="left" valign="top">{checkin_date}</td>
											<td align="left" valign="top">{checkout_date}</td>
											<td align="left" valign="top">{nights}</td>
										</tr>
										<tr
											style="background-color: #F3F3F3; padding-top: 5px; padding-bottom: 5px; color: #2255B5; font-weight: bold;">
											<td align="left" valign="top"
												style="padding-top: 5px; padding-bottom: 5px;"><?php echo JText::_("CP.CAR.TYPE")?>
											</td>
											<td align="left" valign="top"><?php echo JText::_("CP.CAR.PICKUP.CITY")?>
											</td>
										...
										<tr
											style="background-color: #F3F3F3; padding-top: 5px; padding-bottom: 5px; color: #2255B5; font-weight: bold;">
											<td align="left" valign="top"
												style="padding-top: 5px; padding-bottom: 5px;"><?php echo JText::_("CP.QUOTE.QUANTITY")?>
											</td>
											<td align="left" valign="top"><?php echo JText::_("CP.QUOTE.SERVICE")?>
											</td>
											<td align="left" valign="top"><?php echo JText::_("CP.QUOTE.RATE")?>
											</td>
										</tr>
										{rate_product}
										<tr
