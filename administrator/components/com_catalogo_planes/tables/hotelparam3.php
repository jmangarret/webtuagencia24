 ...
 *
 * @version $Id: hotelparam3.php 2012-09-11 8:29:50 svn $
...
* @subpackage       catalogo_planes
*/
class TableHotelParam3 extends BasicTable {
    ...
    function __construct(& $db) {
        ...
        $this->relations['hotels']['referencedtable'] = '#__cp_hotels_param3';
        $this->relations['hotels']['referencedfield'] = 'param3_id';
        ...
        parent::__construct('#__cp_prm_hotels_param3', 'param3_id', $db);
    }
    ...
    function check() {
        ...
        if (!$this->param3_name) {
            $this->setError(JText::_('CP.HOTELPARAM3_ERROR_EMPTY_NAME'));
            return false;
        }
        ...
        if ($id) {
            $this->setError(JText::_('CP.HOTELPARAM3_ERROR_DUPLICATE_NAME'));
            return false;
        }
    ...
    function delete($oid = null) {
        ...
        if ($id) {
        	$query = 'SELECT product_id FROM #__cp_hotels_param3 WHERE param3_id = ' . $id;
        	$this->_db->setQuery($query);
        	$obj = $this->_db->loadObject();
        	if ($obj) {
        		$this->setError(JText::sprintf('CP.HOTELPARAM3_ERROR_DELETE_EXISTS_RELATED_PRODUCTS', $id));
        		return false;
        	}
        }
