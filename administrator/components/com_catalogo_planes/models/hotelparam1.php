 ...
 *
 * @version $Id: hotelparam1.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelHotelParam1 extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		$this->_filter_prefix = $option . '_hotelparam1';
    }
	...
	public function getRelatedProducts ($id) {
		$query = 'SELECT a.product_id, a.product_name FROM #__cp_hotels_param1 b JOIN #__cp_hotels_info a ' . 
