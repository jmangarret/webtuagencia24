...
<form action="<?php echo JRoute::_('index.php?option=com_jhotelreservation') ?>" method="post" name="userForm" id="userForm">
		...
		<table width="100%" cellspacing="0" class="left" >
			...
			<TR>
				<TD align=left colspan=1>	
					<!--micod
					Reemplzas el comentario que aparece debajo de la cotización
					<?php //echo JText::_('LNG_OVERVIEW_RESERVATION_INFO');?> 
					-->
					Arriba está el resumen de su cotización. Si desea cambiar algún dato, haga clic en el botón "atras".
				</TD>
			</TR>
				...
				<tr>
					...
					<td class="right">
						<button class="ui-hotel-button " name="checkRates" type="submit" onclick="return checkContinue();">
							...
							<!--micod-->
								<?php //echo JText::_('LNG_MAKE_RESERVATION');?>Enviar
							</span>
						</button>
					</td>
				</tr>
	...
	<script>
		...
		function showTerms(){
			...
			jQuery.blockUI({ message: jQuery('#conditions'), css: {width: '70%',top: '5%', position: 'absolute',cursor:'pointer'} }); 
