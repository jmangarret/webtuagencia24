...
<script type="text/javascript">
	...
	function submitbutton(pressbutton) {
		...
		// do field validation
		if (jQuery.trim(form.zone_name.value) == "") {
			alert("<?php echo JText::_('CP.ZONE_ERROR_EMPTY_NAME', true); ?>");
		} else {
			submitform(pressbutton);
		}
	}
	...
	<table class="admintable">
		<tr>
			<td align="right" class="key">
				<label for="zone_name">
					<?php echo JText::_('CP.ZONE_NAME'); ?>: *
				</label>
			</td>
			<td>
				<input class="text_area" type="text" name="zone_name" id="zone_name" size="32" maxlength="100" value="<?php echo htmlspecialchars($data->zone_name, ENT_COMPAT, 'UTF-8'); ?>" />
			</td>
		</tr>
		<tr>
			<td align="right" class="key">
