...
<table>
	...
	<td align="left" width="100%">
		...
		<button onclick="document.getElementById('search').value='';document.getElementById('category_id').selectedIndex=0;document.getElementById('tourismtype_id').selectedIndex=0;document.getElementById('city_id').selectedIndex=0;document.getElementById('country_id').selectedIndex=0;document.getElementById('region_id').selectedIndex=0;this.form.getElementById('filter_state').value='';this.form.submit();"><?php echo JText::_('RESET'); ?></button>
	</td>
	<td nowrap="nowrap">
            <?php
...
<div id="editcell">
	...
	<thead>
            <tr>
                ...
                <th class="title">
                    <?php echo JHTML::_('grid.sort', 'CP.PLAN_EDITOR', 'editor', $this->lists['order_Dir'], $this->lists['order']); ?>
                </th>
                <th class="title">
                    <?php echo JHTML::_('grid.sort', 'CP.ROW_UPDATED_DATE', 'modified', $this->lists['order_Dir'], $this->lists['order']); ?>
                </th>
                <th class="title">
                    <?php echo JHTML::_('grid.sort', 'CP.PLAN_CATEGORY', 'category_name', $this->lists['order_Dir'], $this->lists['order']); ?>
                </th>
                <th class="title">
    ...
    for ($i = 0, $n = count($this->data); $i < $n; $i++) {
        ...
        $modified_date = JHTML::_('date', $row->modified, 'd/m/Y h:m A');
        ...
        <tr class="<?php echo "row$k"; ?>">
            ...
            <td>
                ...
                <a href="<?php echo $link; ?>"><?php echo $this->escape($row->product_name); ?></a></span>
            </td>
            <td align="center">
