...
<div id="editcell">
	...
	<thead>
           <tr>
            ...
            <th class="title">
                <?php echo JHTML::_('grid.sort', 'CP.CAR_EDITOR', 'editor', $this->lists['order_Dir'], $this->lists['order']); ?>
            </th>
            <th class="title">
                <?php echo JHTML::_('grid.sort', 'CP.ROW_UPDATED_DATE', 'modified', $this->lists['order_Dir'], $this->lists['order']); ?>
            </th>
            <th class="title">
                <?php echo JHTML::_('grid.sort', 'CP.CAR_CATEGORY_NAME', 'category_name', $this->lists['order_Dir'], $this->lists['order']); ?>
            </th>
            <th class="title">
