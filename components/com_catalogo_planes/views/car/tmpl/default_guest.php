...
<div class="conte_plan">
	...
	<form
		action="<?php echo JRoute::_("index.php?option=com_catalogo_planes&view=car&layout=booking")?>"
				...
				<table>
					...
					<?php if($i<$this->data["guest"]["adults"]):?>
						...
						<td><?php echo JText::_("CP.GUEST.LASTNAME")?>* <input
							type="hidden" name="guest[<?php echo $i?>][type]"
							value="<?php echo $paxType?>">
						</td>
					</tr>
					<tr>
					<?php if($i<$this->data["guest"]["adults"]):?>
				...
				<div>
					<div class="conte_condition">
						<input type="checkbox" name="conditions_check"
							...
							id="button_next"> <?php echo JText::_("CP.CAR.BUTTON.DETAIL.SELECT")?>
...
<div class="conte_tarif">
	...
	<div class="detalles_precio_plan">
		...
		<?php echo JText::_("CP.BOOKING.INFO")?>
			<a target="_BLANK"
				href="<?php echo JRoute::_("index.php?option=com_catalogo_planes&view=car&layout=pdfdetail&format=pdf");?>">
				<img alt="PDF"
		...
		<div class="conte_resume" style="padding: 15px 13px;">
			<div class="title">
			...
			<br />
			<div>
				<strong><?php echo JText::_("CP.CAR.DATE.HOUR.CHECKIN").": "?> </strong>
				<?php echo $this->data["date"]["checkin"]." ".$this->data["date"]["checkin_hour"]?>
			</div>
			<div>
				<strong><?php echo JText::_("CP.CAR.DATE.HOUR.CHECKOUT").": "?> </strong>
				<?php echo $this->data["date"]["checkout"]." ".$this->data["date"]["checkout_hour"]?>
			</div>
			<div>
				<strong><?php echo JText::_("CP.QUOTE.DURATION").": "?> </strong>
				<?php echo $this->data["duration_text"];?>
			</div>
			<div>
				<strong><?php echo JText::_("CP.CAR.TYPE").": "?> </strong>
		...
		<table>
			<tr>
				<th><?php echo JText::_("CP.CAR.GUEST.ROOM.QUANTITY")?></th>
				<th><?php echo JText::_("CP.CAR.GUEST.ROOM.SERVICE")?></th>
				<th><?php echo JText::_("CP.CAR.GUEST.ROOM.RATE")?></th>
			</tr>
			...
			<tr>
				...
				<?php echo JText::_("CP.CAR.SUBTOTAL")?>
					</div></td>
