...
function initializeHotelMap() {
	 ...
	 var mapdiv = document.getElementById("hotel_map");
	  ...
	  var image = '<?php echo JURI::base() ."/components/".getBookingExtName()?>/assets/img/marker.png';
	...
	function loadScript() {
	  ...
	  script.src = "http://maps.googleapis.com/maps/api/js?sensor=false&callback=initializeHotelMap";
