...
<div id="editcell">
	...
	<thead>
            <tr>
                ...
                <th class="title">
                    <?php echo JHTML::_('grid.sort', 'CP.HOTEL_EDITOR', 'editor', $this->lists['order_Dir'], $this->lists['order']); ?>
                </th>
                <th class="title">
                    <?php echo JHTML::_('grid.sort', 'CP.ROW_UPDATED_DATE', 'modified', $this->lists['order_Dir'], $this->lists['order']); ?>
                </th>
                <th class="title">
                    <?php echo JHTML::_('grid.sort', 'CP.HOTEL_STARS', 'stars', $this->lists['order_Dir'], $this->lists['order']); ?>
                </th>
                <th class="title">
    ...
    for ($i = 0, $n = count($this->data); $i < $n; $i++) {
        ...
        $modified_date = JHTML::_('date', $row->modified, 'd/m/Y H:i');
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td align="center">
				<?php echo $row->city_name . ', ' . $row->country_name; ?>
                        ...
                        <td align="center">
                            <?php echo str_repeat('<img src="' . COM_CATALOGO_PLANES_IMAGESURL . '/star.png" />', $row->stars); ?>
                        </td>
                        <td align="center">
