...
<form action="index.php" method="post" name="adminForm" id="adminForm">
	<div id="editcell">
		<TABLE id="itemList" class="table table-striped adminlist">
			<thead>
				<th width='1%'>#</th>
				<th width='1%'>&nbsp;</th>
			...
			>
				...
				<TD align=center>
					<?php echo JHtml::_('grid.id', $i, $reviewQuestion->review_question_id); ?>
				</TD>
				<TD align=left style="padding-left:50px;">	
					<a href='<?php echo JRoute::_( 'index.php?option='.getBookingExtName().'&view=manageratingquestions&task=managehotelratings.editratingquestion&cid[]='. $reviewQuestion->review_question_id )?>' title		= 	"<?php echo JText::_('LNG_CLICK_TO_EDIT',true); ?>">			
