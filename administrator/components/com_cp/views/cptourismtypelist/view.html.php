 ...
 * @subpackage 	Cp
 */
class CPViewCPTourismTypeList extends JViewLegacy {
	protected $items;
	...
	/**
	 * cptourismtypelist view display method
	 * @return void
	 **/
	function display($tpl = null) {
		...
		JToolBarHelper::title(JText::_('COM_CP_CP_MANAGER') . ' - ' . JText::_('COM_CP_MENUCPTOURISMTYPELIST'), 'generic.png');
		if ($user->authorise('core.create', 'com_cp')) {
			JToolBarHelper::addNewX('cptourismtype.add');
		}
		if ($user->authorise('core.edit', 'com_cp') || $user->authorise('core.edit.own', 'com_cp')) {
			JToolBarHelper::editListX('cptourismtype.edit');
		}
		if (count($this->items) && $user->authorise('core.edit.state', 'com_cp')) {
			JToolBarHelper::divider();
			JToolBarHelper::publishList('cptourismtypelist.publish');
			JToolBarHelper::unpublishList('cptourismtypelist.unpublish');
		}
		if ($user->authorise('core.delete', 'com_cp')) {
			JToolBarHelper::divider();
			JToolBarHelper::deleteList('COM_CP_CONFIRM_DELETE_TOURISMTYPE', 'cptourismtypelist.delete');
		}
