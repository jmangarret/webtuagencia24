	...
	<fieldset class='adminform'>
		...
		<legend><?php echo JText::_('LNG_EXCURSION_PICTURES'); ?></legend>
		<TABLE class='admintable' align=left border=0>
			<TR>
				<TD align=left class="key"><?php echo JText::_('LNG_PICTURES',true); ?>:</TD>
				<TD>
					<TABLE class="admintable" align=center  id='table_excursion_pictures' name='table_excursion_pictures' >
						<?php
						$pos = 0;
						...
						<TR>
							<TD align=left>
								<textarea cols=50 rows=2 name='excursion_picture_info[]' id='excursion_picture_info'><?php echo $picture['picture_info']?></textarea>
							</TD>
							<td align=center>
								<img class='img_picture_excursion' src='<?php echo JURI::root().PATH_PICTURES.$picture['picture_path']?>'/>
								<BR>
								<?php echo basename($picture['picture_path'])?>
								<input type='hidden' 
									value='<?php echo $picture['picture_enable']?>' 
									name='excursion_picture_enable[]' 
									id='excursion_picture_enable'
								>
								<input type='hidden' 
									value='<?php echo $picture['picture_path']?>' 
									name='excursion_picture_path[]' 
									id='excursion_picture_path'
								>
							</td>
							<td align=center>
							...
							<td align=center>
								<img class='btn_picture_status' 
									src='<?php echo JURI::base() ."components/".getBookingExtName()."/assets/img/".($picture['picture_enable'] ? 'checked' : 'unchecked').".gif"?>'
									onclick =  " 
												...
												{
													v_status  = form.elements['excursion_picture_enable[]'][<?php echo $pos ?>];
												}
