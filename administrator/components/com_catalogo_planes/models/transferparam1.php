 ...
 *
 * @version $Id: transferparam1.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelTransferParam1 extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		$this->_filter_prefix = $option . '_transferparam1';
    }
	...
	public function getOrderByField() {
		...
		if (!in_array($filter_order, array('param1_id', 'param1_name', 'published'))) {
    ...
    public function getRelatedProducts ($id) {
        $query = 'SELECT a.product_id, a.product_name FROM #__cp_transfers_param1 b JOIN #__cp_transfers_info a ' . 
