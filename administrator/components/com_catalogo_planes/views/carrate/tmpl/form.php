...
<script type="text/javascript">
    ...
    function addSeason (season_id) {
        var url = "index.php?option=<?php echo $option; ?>&view=season&task=getrawlistbyproducttype&format=raw&product_type_code=cars";
...
Joomla.submitbutton = function(pressbutton) {
        ...
        if (form.season_id.selectedIndex == 0) {
        ...
        } else if (jQuery.trim(day_rate_field.val()) == "" || parseFloat(jQuery.trim(day_rate_field.val())) <= 0) {
            alert("<?php echo JText::_('CP.CAR_ERROR_EMPTY_RATE_DAY_PRICE', true); ?>");
            day_rate_field.focus();
        } else {
            var submit = true;
	        ...
	        var url = "index.php?option=<?php echo $option; ?>&view=carrate&task=checkseasonoverlapping&format=raw&season_id=";
                ...
                <td valign="top">
                    ...
                    <table class="admintable" border="0">
                        <tr>
                            ...
                            <td><?php echo JText::_('CP.CAR_RATE_BASIC_PRICE_DESCRIPTION'); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td><?php echo JText::_('CP.CAR_RATE_PREVIOUS_VALUE_DESCRIPTION'); ?></td>
                        </tr>
                    </table>
                </td>
                <td valign="top">
                ...
                <fieldset>
                    ...
                    <table class="listrateparams">
                        <tr>
                            ...
                            <th class="odd"><?php echo JText::_('CP.CAR_RATE_PARAM2_ID1_LABEL'); ?></th>
                            <th class="odd"><?php echo JText::_('CP.CAR_RATE_PARAM2_ID2_LABEL'); ?>*</th>
                        </tr>
                        <tr>
                            <td class="even"><?php echo JText::_('CP.CAR_RATE_PARAM1_ID1_LABEL'); ?></td>
                            <td class="even">
