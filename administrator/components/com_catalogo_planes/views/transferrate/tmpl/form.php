...
<script type="text/javascript">
    ...
    function addSeason (season_id) {
        var url = "index.php?option=<?php echo $option; ?>&view=season&task=getrawlistbyproducttype&format=raw&product_type_code=transfers";
    ...
    function submitbutton(pressbutton) {
        ...
        if (form.season_id.selectedIndex == 0) {
	        ...
	        var url = "index.php?option=<?php echo $option; ?>&view=transferrate&task=checkseasonoverlapping&format=raw&season_id=";
                ...
                <td valign="top">
                    ...
                    <table class="admintable" border="0">
                        <tr>
                            ...
                            <td><?php echo JText::_('CP.TRANSFER_RATE_BASIC_PRICE_DESCRIPTION'); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td><?php echo JText::_('CP.TRANSFER_RATE_PREVIOUS_VALUE_DESCRIPTION'); ?></td>
                        </tr>
                    </table>
                </td>
                <td valign="top">
            ...
            <tr>
                ...
                <?php
                    ...
                    foreach ($data->prices as $row) {
                    	...
                    	$prices[$param1][$param2][$param3] = $row->price;
                    }
                    ...
                    foreach ($this->rateParams['param3'] as $param3) {
                    	...
                    	foreach ($this->rateParams['param1'] as $key => $param1) {
	                    	...
	                    	foreach ($this->rateParams['param2'] as $param2) {
	                    		...
	                    		$price = (isset($prices[$param1_id][$param2_id][$param3_id]))? $prices[$param1_id][$param2_id][$param3_id]: 0;
