...
<script type="text/javascript">
	...
	jQuery.noConflict()(document).ready(function ($) {
        ...
        if ($data->product_id < 1) {
        	echo '$(\'#details_disclaimer\').val("' . JText::_('CP.TOUR_DISCLAIMER_DEFAULT_VALUE') . '");';
        }
        ?>
        ...
        var elementsOrder = ["product_name", "detailscountry_id", "detailsregion_id", "detailscity_id",
                             ...
                             "details_published0", "details_product_url", "selecttaxes", "selectdeliverycities","details_duration"];
        ...
        $('#details_publish_down').datepicker({
            ...
            beforeShow: function(input, inst) {
                $.datepicker._updateDatepicker = function(inst) {
                    ...
                    $("<button style='float:none;text-align:center;width:100%;' class='ui-datepicker-clean ui-state-default ui-priority-primary ui-corner-all'>Nunca despublitour</button>").appendTo(buttonPane).click(function(ev) {
        ...
        $("#supplement_product_types,#supplement_tourism_types").change(function() {
            ...
            generateSelectByAjax(url, 'supplement_list', 'supplement_id', 'supplement_name', '0', emptySelectOption, assignedSupplementList, "supplement_search_message", "<?php echo JText::_('CP.TOUR_SUPPLEMENT_SEARCH_NO_RESULTS_MESSAGE', true); ?>");
        });
...
Joomla.submitbutton = function(pressbutton) {
        ...
        if (jQuery.trim(form.product_name.value) == "") {
            ...
            alert("<?php echo JText::_('CP.TOUR_ERROR_EMPTY_TOURCATEGORY', true); ?>");
...
// Si hay suplementos creados, debe tourgarse su información en div's ocultos
$content = '';
if (count($data->supplements)) {
	foreach ($data->supplements as $key => $row) {
...
?>
        <fieldset>
            <legend><?php echo JText::_('CP.TOUR_SUPPLEMENT_SEARCH_LABEL'); ?></legend>
