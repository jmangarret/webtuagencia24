 ...
 *
 * @version $Id: transferparam3.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelTransferParam3 extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		$this->_filter_prefix = $option . '_transferparam3';
    }
    ...
    public function getRelatedProducts ($id) {
        $query = 'SELECT a.product_id, a.product_name FROM #__cp_transfers_param3 b JOIN #__cp_transfers_info a ' . 
