...
class PayFlowTransaction 
{
	...
	public $gateway_url_live 	= '';//PAYPAL_LIVE;
	public $gateway_url_devel 	= '';//PAYPAL_TEST;
	...
	public function load_config() 
	{
		...
		if ( defined('PAYFLOWPRO_CURRENCY') ) 
		{
			$this->data['CURRENCY'] = constant('PAYFLOWPRO_CURRENCY');
		}
		...
		if ( defined('PAYFLOWPRO_ACTION') ) 
		{
			$this->data['ACTION'] = constant('PAYFLOWPRO_ACTION');
		}
		...
		if ( defined('PAYFLOWPRO_ORIGID') ) 
		{
			$this->data['ORIGID'] = constant('PAYFLOWPRO_ORIGID');
		}
		
		if ( defined('PAYFLOWPRO_DOREAUTORIZATION') ) 
		{
			$this->data['DOREAUTORIZATION'] = constant('PAYFLOWPRO_DOREAUTORIZATION');
		}
		
		if ( defined('PAYFLOWPRO_CAPTURECOMPLETE') ) 
		{
			$this->data['CAPTURECOMPLETE'] = constant('PAYFLOWPRO_CAPTURECOMPLETE');
		}
