...
$config = array(
        'url'=>'http://192.168.1.10:8080/ostickets.test/upload/api/tickets.json',  // URL to site.tld/api/tickets.json //Antes era -> http://your.domain.tld/api/tickets.json
    'key'=>'975E4FB6596BE6EBA025A24168523104'  // API Key goes here //PUTyourAPIkeyHERE
);
...
$data = array(
    'name'      =>      'Reo53 Reo54',  // from name aka User/Client Name
