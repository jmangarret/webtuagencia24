...
class CatalogoPlanesViewPlan extends JView {
  ...
  function display($tpl = null) {
    ...
    switch($this->getLayout()){
      case "availability"://Se importan los estilos y los scripts de la disponibilidad
        ...
        //Adiciona la url para generar mapas-verifica si la url esta arriba
      ...
      case "detail"://Se importan los estilos y los scripts del detalle
        ...
        $script2 .= "var messageErrorAdult = '".JText::_("CP.PLAN.ADULT.ROOM.ACCOMMODATIONS.MESSAGE")."';";
        $script2 .= "var messageErrorChild = '".JText::_("CP.PLAN.CHILD.ROOM.MESSAGE")."';";
        $document->addScriptDeclaration($script2);

        //Se agrega el script del detalle
        $document->addScript($this->root_path.'js/plan.detail.js');
      ...
      case "default"://Estos estilos son mas generales aunque se aplican a la pantalla de pasajeros
        ...
        //Se agrega el script
        $document->addScript($this->root_path.'js/plan.guest.js');
