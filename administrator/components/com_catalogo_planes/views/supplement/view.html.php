...
class CatalogoPlanesViewSupplement extends JView {
	...
	function display ($tpl = null) {
		...
		if ($layout == 'form') {
			...
			$this->assignRef('supplement_image_folder', $params->get('cfg_supplement_image_folder'));
			...
			// Obtiene título de la interfaz
			$title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.SUPPLEMENT');
		}
		// Agrega título de la plantilla
		JToolBarHelper::title($title, 'supplement.png');
