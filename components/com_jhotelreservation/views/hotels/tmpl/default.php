					...
					<div class="hotel-info row-fluid">
						...
						<div class="hotel-details span3">
							<?php if($hotel->noReviews >= MINIMUM_HOTEL_REVIEWS) {?>
								<div class="hotel-rating">
									<div class="info">
										...
										<a href="<?php echo JHotelUtil::getHotelLink($hotel).'?'.strtolower(JText::_("LNG_REVIEWS")); ?>"><?php echo $hotel->noReviews?> <?php echo JText::_("LNG_REVIEWS")?></a>
									</div>
									<div class="rating">
							...
							<div class="hotel-price">
								<span class="price-type"> <?php  //echo JText::_('LNG_ROOMS',true);?>Habitaciones </span>
								<span class="details"><?php  echo JText::_('LNG_FROM',true);?> </span>
								<span class="price"><?php echo $hotel->currency_symbol ?> <?php echo JHotelUtil::fmt($hotel->min_room_price,2) ?></span><br><!--Salto de línea para ajustar mejor el precio de los hoteles-->
								
								<span class="details"><?php echo $this->appSettings->show_price_per_person == true ?"Por Persona por Noche":"Por Habitación por Noche" ?></span><!--original p.p.p.n por persona y p.r.p.n por habitación-->
								<div class="view-hotel">
									<a href="<?php echo JHotelUtil::getHotelLink($hotel) ?>"><?php  //echo JText::_('LNG_VIEW_HOTEL',true);?> Ver Hotel</a>
								</div>
							</div>
							<?php } ?>
												...
												<li class="clear">
													<div class="overview">
														...
														<div class="price">
															...
															<a class="ui-hotel-button prevent-click" href="<?php echo JHotelUtil::getHotelLink($hotel)?>">
													...
													<div class="overview row-fluid">
														...
														<div class="span5 package-cell">
															...
															<div class="price">
																...
																<a class="ui-hotel-button prevent-click right" href="<?php echo JHotelUtil::getHotelLink($hotel)?>">
																	<span class="ui-button-text"><?php echo JText::_('LNG_BOOK',true)?></span>
																</a>
