 ...
 *
 * @version $Id: planparam2.php 2012-09-11 8:29:50 svn $
...
* @subpackage       catalogo_planes
*/
class TablePlanParam2 extends BasicTable {
    ...
    function __construct(& $db) {
        ...
        $this->relations['plans']['referencedtable'] = '#__cp_plans_param2';
        $this->relations['plans']['referencedfield'] = 'param2_id';
        ...
        parent::__construct('#__cp_prm_plans_param2', 'param2_id', $db);
    }
    ...
    function check() {
        ...
        if (!$this->param2_name) {
            $this->setError(JText::_('CP.PLANPARAM2_ERROR_EMPTY_NAME'));
            return false;
        }
        ...
        if ($id) {
            $this->setError(JText::_('CP.PLANPARAM2_ERROR_DUPLICATE_NAME'));
            return false;
        }
    ...
    function delete($oid = null) {
        ...
        if ($id) {
        	$query = 'SELECT product_id FROM #__cp_plans_param2 WHERE param2_id = ' . $id;
        	$this->_db->setQuery($query);
        	$obj = $this->_db->loadObject();
        	if ($obj) {
        		$this->setError(JText::sprintf('CP.PLANPARAM2_ERROR_DELETE_EXISTS_RELATED_PRODUCTS', $id));
        		return false;
        	}
        }
