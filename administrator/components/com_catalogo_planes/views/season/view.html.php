...
class CatalogoPlanesViewSeason extends JView {
	...
	function display ($tpl = null) {
		...
		if ($layout == 'standard' || $layout == 'special') {
			...
			JToolBarHelper::editListX();
                        JToolBarHelper::customX('newSpecialSeason', 'new-special-season', '', JText::_('CP.SEASON_CREATE_TYPE_SPECIAL'), false);
			JToolBarHelper::addNewX();

                        JSubMenuHelper::addEntry(JText::_('CP.PRINCIPAL_VIEW'), 'index.php?option=' . $option);

			// Obtiene título de la interfaz
			$title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.SEASON');
		}
		// Agrega título de la plantilla
		JToolBarHelper::title($title, 'season.png');
