					...
					<div id="extra-options-container">
						<?php
							foreach( $this->_models['variables']->extraOptions as $item ){
								$is_checked = false;
								//dump($this->_models['variables']->items_reserved);
							...
							?>
								<div class="extra-option">
									...
									<strong><?php echo $item->name ?></strong>,	<?php echo $this->_models['variables']->itemCurrency->currency_symbol?> <?php echo fmt($item->price,2) ?><?php echo $item->price_type == 1?",&nbsp;".strtolower(JText::_('LNG_PER_PERSON",true)):"" ?><?php  echo $item->is_per_day == 1 ?",&nbsp;".JText::_('LNG_PER_DAY",true):"" ?><?php  echo $item->is_per_day == 2 ?',&nbsp;".JText::_("LNG_PER_NIGHT',true):"" ?>
