...
<legend><?php echo JText::_( 'LNG_WIZARD_OFFER_PACKAGES' ,true); ?></legend>
					<TABLE class="admintable" align=center border=0>
						...
						<TR>
							...
							<TD nowrap ALIGN=LEFT>
								<div id="theme-holder" class="option-holder">
									<?php
										echo $this->getModel()->displayThemes( $this->item->themes, $this->item->selectedThemes );
									?>
								</div>
								<?php 
							...
							<TD nowrap colspan=2 ALIGN=LEFT>
								<?php
									...
									foreach( $dirs  as $_lng ){
										...
										$langContent = isset($this->offerShortDescTranslations[$_lng])?$this->offerShortDescTranslations[$_lng]:"";
										$editor =JFactory::getEditor();
										echo $editor->display('offer_short_description_'.$_lng, $langContent, '800', '400', '70', '15', false);
						...
						<TR>
							...
							<TD nowrap colspan=2 ALIGN=LEFT>
								<?php 
										echo JHtml::_('tabs.start', 'tab_groupd_id', $options);
										...
										foreach( $dirs  as $_lng ){
											echo JHtml::_('tabs.panel', $_lng, 'tab'.$j );						
											$langContent = isset($this->offerTranslations[$_lng])?$this->offerTranslations[$_lng]:"";
											$editor =JFactory::getEditor();
											echo $editor->display('offer_description_'.$_lng, $langContent, '800', '400', '70', '15', false);
						...
						<TR>
							...
							<TD nowrap colspan=2 ALIGN=LEFT>
								<?php 
									...
									echo JHtml::_('tabs.start', 'tab_groupc_id', $options);
									...
									foreach( $dirs  as $_lng ){
										echo JHtml::_('tabs.panel', $_lng, 'tab'.$j );						
										$langContent = isset($this->offerContentTranslations[$_lng])?$this->offerContentTranslations[$_lng]:"";
										$editor =JFactory::getEditor();
										echo $editor->display('offer_content_'.$_lng, $langContent, '800', '400', '70', '15', false);
						...
						<TR>
							...
							<TD nowrap colspan=2 ALIGN=LEFT>
								<?php 
									...
									foreach( $dirs  as $_lng ){
										echo JHtml::_('tabs.panel', $_lng, 'tab'.$j );						
										$langContent = isset($this->offerOtherInfoTranslations[$_lng])?$this->offerOtherInfoTranslations[$_lng]:"";
										$editor =JFactory::getEditor();
										echo $editor->display('offer_other_info_'.$_lng, $langContent, '800', '400', '70', '15', false);
									}
									echo JHtml::_('tabs.end');
								?>
							</TD>
						...
						<TR>
							<TD width=10% nowrap class="key"><?php echo JText::_( 'LNG_MINIMUM_PERSONS' ,true); ?> :</TD>
							<TD nowrap colspan=2 ALIGN=LEFT>
								<input 
									type		= "text"
									name		= "offer_min_pers"
									id			= "offer_min_pers"
									value		= '<?php echo $this->item->offer_min_pers !=0 ? $this->item->offer_min_pers : ''?>'
									size		= 2
									maxlength	= 5
								/>
							</TD>
						...
						<TR>
							...
							<TD nowrap width=1% align=left>
								...
								<?php 
								echo JHTML::_('calendar', $this->item->offer_datas==$this->appSettings->defaultDateValue ? '' : $this->item->offer_datas, 'offer_datas', 'offer_datas', $this->appSettings->calendarFormat, array('class'=>'inputbox', 'size'=>'10',  'maxlength'=>'10')); ?>
								<?php echo JHTML::_('calendar', $this->item->offer_datas==$this->appSettings->defaultDateValue ? '' : $this->item->offer_datae, 'offer_datae', 'offer_datae', $this->appSettings->calendarFormat, array('class'=>'inputbox', 'size'=>'10',  'maxlength'=>'10')); ?>
								<!--  input 
									type	='hidden' 
									name	='offer_datas' 
									id		='offer_datas'
						...
						<TR>
							...
							<TD nowrap width=1% align=left>
								<?php echo JHTML::_('calendar', $this->item->offer_datasf==$this->appSettings->defaultDateValue ? '' : $this->item->offer_datasf, 'offer_datasf', 'offer_datasf', $this->appSettings->calendarFormat, array('class'=>'inputbox', 'size'=>'10',  'maxlength'=>'10')); ?>
								<?php echo JHTML::_('calendar', $this->item->offer_datasf==$this->appSettings->defaultDateValue ? '' : $this->item->offer_dataef, 'offer_dataef', 'offer_dataef', $this->appSettings->calendarFormat, array('class'=>'inputbox', 'size'=>'10',  'maxlength'=>'10')); ?>
							</TD>
							<TD>&nbsp;</TD>
						</TR>
					</TABLE>
