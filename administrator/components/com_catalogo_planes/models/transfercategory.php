 ...
 *
 * @version $Id: transfercategory.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelTransferCategory extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		parent::__construct();
                ...
                $this->_filter_prefix = $option . '_transfercategory';
    }
	...
	public function getOrderByField() {
		...
		if (!in_array($filter_order, array('category_id', 'category_name', 'transfer_type', 'published'))) {
