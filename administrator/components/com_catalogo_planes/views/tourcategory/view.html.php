...
class CatalogoPlanesViewTourCategory extends JView {
	...
	function display ($tpl = null) {
		...
		if ($layout == 'form') {
			...
			// Obtiene título de la interfaz
			$title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.TOURCATEGORY');
		}
		// Agrega título de la plantilla
		JToolBarHelper::title($title, 'tour.png');
