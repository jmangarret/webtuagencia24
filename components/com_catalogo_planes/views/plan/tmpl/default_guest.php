...
<div class="conte_plan">
	...
	<form
		action="<?php echo JRoute::_("index.php?option=com_catalogo_planes&view=plan&layout=booking")?>"
				...
				<table>
					...
					<tr>
						...
						<td><input maxlength="25" type="text"
							...
							value="<?php echo(isset($guest_before['document']) && $i==0)?$guest_before["document"]:''; ?>"
				...
				<div>
					<div class="conte_condition">
						<input type="checkbox" name="conditions_check"
							...
							id="button_next"> <?php echo JText::_("CP.PLAN.BUTTON.DETAIL.SELECT")?>
...
<div class="conte_tarif">
	...
	<?php echo JText::_("CP.BOOKING.INFO")?>
		<a target="_BLANK"
			href="<?php echo JRoute::_("index.php?option=com_catalogo_planes&view=plan&layout=pdfdetail&format=pdf");?>">
			<img alt="PDF"
	...
	<div class="detalles_precio_plan">
		<h3 class="seccion_title">
			<img
				...
				<?php echo JText::_("CP.PLAN.DATES.TITLE");?>
		</h3>
		<div class="conte_resume">
			<div>
				<strong><?php echo JText::_("CP.PLAN.DATE.CHECKIN").": "?> </strong>
				<?php echo $this->data["date"]["checkin"]?>
			</div>
			<div>
				<strong><?php echo JText::_("CP.PLAN.NUMBER.NIGHTS").": "?> </strong>
				<?php echo $this->data["duration_text"]?>
			</div>
		</div>
		<h3 class="seccion_title">
			<img
				...
				<?php echo JText::_("CP.PLAN.GUESTS.TITLE");?>
		</h3>
		<div class="conte_resume">
			<div>
				<strong><?php echo JText::_("CP.PLAN.ADULTS").": "?> </strong>
				<?php echo $this->data["guest"]["adults"]?>
			</div>
			<?php if($this->data["guest"]["childs"]>0):?>
			<div>
				<strong><?php echo JText::_("CP.PLAN.CHILDS").": "?> </strong>
		...
		<h3 class="seccion_title">
			<img
				...
				<?php echo JText::_("CP.PLAN.HOTEL.TITLE");?>
		</h3>
		<div class="conte_resume">
			<div>
				<strong><?php echo JText::_("CP.PLAN.HOTEL").": "?> </strong>
				<?php echo $this->data["rates"][0]["pamam1"]["name"]?>
			</div>
		</div>
		<h3 class="seccion_title">
			<img
		...
		<div class="conte_resume">
			<table class="info_tarifas">
				<tr>
					<th><?php echo JText::_("CP.PLAN.GUEST.ROOM.QUANTITY")?></th>
					<th><?php echo JText::_("CP.PLAN.GUEST.ROOM.SERVICE")?></th>
					<th><?php echo JText::_("CP.PLAN.GUEST.ROOM.RATE")?></th>
				</tr>
				<?php foreach($this->data["rates"] as $rate):?>
				<tr>
					<td style="text-align: center"><?php echo $rate["quantity"]?></td>
					<td><?php echo $rate["pamam2"]["name"]." - ".$rate["pamam3"]["name"]?>
					</td>
				...
				<?php endforeach;?>
				<?php if($this->data["guest"]["childs"]>0):?>
				<?php foreach($this->data["childs"] as $childs):?>
				<tr>
					<td style="text-align: center"><?php echo $childs["quantity"]?></td>
					<td><?php echo JText::_("CP.PLAN.CHILDS")." - ".$childs["param3"]["name"]?>
					</td>
					<td align="left"><?php echo $this->getFormatPrice($childs["totalPrice"],$this->data["currency"]["symbol"])?>
					</td>
				</tr>
				<?php endforeach;?>
				...
				<tr>
					...
					<?php echo JText::_("CP.PLAN.SUBTOTAL")?>
						</div></td>
				...
				<tr>
					<td></td>
					<td><div class="subtotal">
					<?php echo JText::_("CP.PLAN.TAXES")?>
						</div></td>
