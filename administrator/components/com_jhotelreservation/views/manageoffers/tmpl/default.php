				...
				<div id="boxes">
					<TABLE class="table table-striped adminlist"  name='table_offers' id='table_offers'>
						...
						>
							...
							<TD align=center>
								<?php echo $offer->offer_datasf=='0000-00-00' ? "&nbsp;" : getDateGeneralFormat($offer->offer_datasf)?>
								<?php echo JText::_( 'LNG_TO' ,true); ?>		
								<?php echo $offer->offer_dataef=='0000-00-00' ? "&nbsp;" : getDateGeneralFormat($offer->offer_dataef)?>
							</TD>
							<TD align=center>
								<?php echo $offer->offer_datas=='0000-00-00' ? "&nbsp;" : getDateGeneralFormat($offer->offer_datas)?>
								<?php echo JText::_( 'LNG_TO' ,true); ?>	
								<?php echo $offer->offer_datae=='0000-00-00' ? "&nbsp;" : getDateGeneralFormat($offer->offer_datae)?>
							</TD>
								<?php 
									if (checkUserAccess(JFactory::getUser()->id,"manage_featured_hotels")){
								?>
