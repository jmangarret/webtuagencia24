...
<form autocomplete="off" action="<?php echo JRoute::_('index.php') ?>" method="post" name="userForm" id="userForm" >
	<div class="hotel_reservation">
		...
		<?php
		// dbg($this->_models['variables']->itemPackages);
					...
					<TD valign=top colspan=6>
						<TABLE width=100% valign=top class="table_info" cellspacing="0">
							...
							<TR>
								...
								<TD align=right>
									<?php echo ($value->is_price_day ? "<b><i>" : "").fmt($value->display_price_final,2).($value->is_price_day ? "</b></i>" : "")?> <?php echo $value->is_price_day ? "( ".JText::_('LNG_PER_DAY',true)." )  " : ""?>
								</TD>
												...
												<div id="tabs-package-1_<?php echo $value->package_id; ?>" ><?php echo JText::_('LNG_PRICE_PER_PERSON',true)?>
													...
													<table>
														...
														<tr class="price_breakdown_grad_total">
															...
															<td>
																<?php echo fmt($value->display_price_final,2)?>  (<?php echo $this->_models['variables']->currency_selector?>) (<?php echo  JText::_('LNG_PACKAGE_PRICE',true) ?>)
															</td>
														</tr>
														...
														else
														{
															...
															foreach( $value->daily as $daily )
															{
																...
																<tr>
																	...
																	<td>
																		<?php echo fmt($p,2).' '.$this->_models['variables']->currency_selector?>
																	</td>
																	<td>
																		<input 
																			type='checkbox' 
				...
				<TR>
					<TD valign=top>
						...
						<TABLE width=100% valign=top class='table_arrival_options'>
							<?php
							// dbg($this->_models['variables']->itemArrivalOptions);
							...
							<TABLE width=100% valign=top class='table_arrival_options'>
								...
								<tr>
									...
									<TD width=80%  colspan=3 align=left>
										...
										<?php
										//dbg($this->_models['variables']->itemAirportTransferTypes);
										?>
									</TD>
								</TR>
								<TR>
