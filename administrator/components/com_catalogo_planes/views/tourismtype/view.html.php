...
class CatalogoPlanesViewTourismType extends JView {
	...
	$option = JRequest::getCmd('option');
		...
		if ($layout == 'form') {
                    ...
                    // Obtiene título de la interfaz
                    $title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.TOURISMTYPE');
                    
		}
		// Agrega título de la plantilla
		JToolBarHelper::title($title, 'tourism_type.png');
