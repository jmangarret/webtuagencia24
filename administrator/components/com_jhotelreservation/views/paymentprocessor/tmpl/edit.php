		...
		<table class="admintable" id="table_processor_fields">
			...
			<?php 
				...
				if( count($this->item->processorFields) > 0 )
				{
					...
					{
					?>
					<TR id="options_attr_<?php echo $value->id?>">
						...
						<TD nowrap align=left width=30% align=left valign=center>
							...
							<img
								...
								height  	=12px
								title		='Delete option'
								src ="<?php echo JURI::base() ."components/".getBookingExtName()."/assets/img/icon_delete.png"?>"
								onclick 	="delFeatureRoomOption('options_attr_<?php echo $value->id?>');" 
							...
							?>
								<img 
									...
									height 		=16px
									title		='Add option'
									src ="<?php echo JURI::base() ."components/".getBookingExtName()."/assets/img/addIcon.jpg"?>"
...
{
	return (elem=document.getElementById(pos)).parentNode.removeChild(elem);
}
...
{   var attrType = document.getElementsByName("attribute_type_id");
	...
	img_del.setAttribute('src', "<?php echo JURI::base() ."components/".getBookingExtName()."/assets/img/icon_delete.png"?>");
	img_del.setAttribute('alt', 'Delete option');
	img_del.setAttribute('height', '12px');
	img_del.setAttribute('width', '12px');
	img_del.setAttribute('onclick', 'delFeatureRoomOption(\''+ 'options_attr_'+(id) +'\')');
	...
	tr_new.setAttribute('id', 'options_attr_'+(id));
