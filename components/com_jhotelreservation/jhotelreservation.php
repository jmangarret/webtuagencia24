...
JHTML::_('stylesheet', 	'components/'.getBookingExtName().'/assets/css/form.css');
JHTML::_('stylesheet', 	'components/'.getBookingExtName().'/assets/css/responsive.css');
JHTML::_('stylesheet', 	'components/'.getBookingExtName().'/assets/css/joomlacalendar.css');
...
if( isset($_SESSION['cssStyleComp'] ) ){
	JHTML::_('stylesheet', 'components/'.getBookingExtName().'/assets/css/extension/'.$_SESSION['cssStyleComp']);
}else if( isset($appSettings->css_style) ){
	JHTML::_('stylesheet', 'components/'.getBookingExtName().'/assets/css/extension/'.$appSettings->css_style);
}else{
	JHTML::_('stylesheet', 'components/'.getBookingExtName().'/assets/css/extension/style.css');
}
