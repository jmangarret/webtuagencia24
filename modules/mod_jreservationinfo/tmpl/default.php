...
<div class='reservationinfo<?php echo $moduleclass_sfx ?>' >
	<h4 style="margin-left: 9px;"> Detalles de su Pre-reserva <?php //echo JText::_("LNG_RESERVATION_INFO") ?></h4> <!--MICOD-->
	<div>
	...
	<div class="hotelinfo">
		<div class="hotelcontent">								
			...
			<div class="cost-info">
				<table>
				<!--MICOD
				Comentado el sutotal estimado y el costo de la reserva, no son necesarios.
				Subtotal estimado es siempre igual al total.
				Costo de la reserva es siempre 0.00Bs.F-->
					<!--<tr>
						<td>
