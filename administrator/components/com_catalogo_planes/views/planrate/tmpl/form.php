...
<script type="text/javascript">
    ...
    function addSeason (season_id) {
        var url = "index.php?option=<?php echo $option; ?>&view=season&task=getrawlistbyproducttype&format=raw&product_type_code=plans";
...
Joomla.submitbutton = function(pressbutton) {
        ...
        if (form.season_id.selectedIndex == 0) {
	        ...
	        var url = "index.php?option=<?php echo $option; ?>&view=planrate&task=checkseasonoverlapping&format=raw&season_id=";
        ...
        <table class="admintable" border="0">
                ...
                <td valign="top">
                    ...
                    <table class="admintable" border="0">
                        <tr>
                            ...
                            <td><?php echo JText::_('CP.PLAN_RATE_BASIC_PRICE_DESCRIPTION'); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td><?php echo JText::_('CP.PLAN_RATE_PREVIOUS_VALUE_DESCRIPTION'); ?></td>
                        </tr>
                    </table>
                </td>
                <td valign="top">
            ...
            <tr>
                ...
                <?php
                    ...
                    $header .= '<th class="odd">' . JText::_('CP.PLAN_RATE_CHILD_LABEL') . '</th>';
                    $index = 0;
                    ...
                    foreach ($this->rateParams['param3'] as $param3) {
                    	...
                    	foreach ($this->rateParams['param1'] as $key => $param1) {
	                        ...
	                        $price = (isset($prices[$param1_id][0][$param3_id][1]))? $prices[$param1_id][0][$param3_id][1]: 0;
	                        $content .= '<td class="' . $class . '"><input type="text" name="prices[' . $index . '][price]" value="' . $price . '" class="childrate isdecimal" />';
	                        $content .= '<input type="hidden" name="prices[' . $index . '][param1]" value="' . $param1_id . '" />';
