		...
		foreach($rooms as $room){
			...
			for( $d = strtotime($startDate);$d < strtotime($endDate); ){
				...
				if($room->price_type==1){
					...
					//---------------------------------------------------------------------------------
					//micod
					//LUGAR DONDE ESTOY ANEXANDO EL FEE EN EL CALCULO FINAL DE LA COTIZACIÓN
					//El precio que estoy anexando por persona, tanto adultos como a niños
					...
					$dayPrice = $dayPrice * $totalAdults + $childPrice*$children;
							/*echo "<pre>";
							var_dump($comision, $total_comision_day, $childPrice, $dayPrice, $totalAdults);
							echo "</pre>";*/
					//---------------------------------------------------------------------------------
