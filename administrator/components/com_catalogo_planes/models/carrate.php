 ...
 *
 * @version $Id: carrate.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelCarRate extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		$this->_filter_prefix = $option . '_carrate';
    }
    ...
    function checkSeasonOverlapping($product_id, $season_id, $rate_id) {
        ...
        $query = 'SELECT s1.season_name, s1.is_special, s1.day1, s1.day2, s1.day3, s1.day4, 
            ...
            INNER JOIN #__cp_cars_rate r ON s1.season_id = r.season_id 
