 ...
 * @file 
 * @ingroup _comp_adm
 * Clase usada por el proyecto http://valums.com/ajax-upload/, pero modificada
 * para las necesidades de Amadeus.
 */
...
class qqFileUploader {
    ...
    /**
     * @brief Check the server configuration
     */
    ...
    /**
     * @brief Change the string for an integer that represents the
     * size of the file
    ...
    /**
     * @brief Save the file on the server
     *
