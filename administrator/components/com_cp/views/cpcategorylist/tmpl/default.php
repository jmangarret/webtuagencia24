...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cp&view=cpcategorylist');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th>
					<?php echo JHtml::_('grid.sort', 'COM_CP_CATEGORY_NAME', 'category_name', $listDirn, $listOrder); ?>
				</th>
				<th>
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if ($canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_cp&task=cpcategory.edit&category_id='.$item->category_id);?>">
				...
				<td class="center">
					<?php echo JHtml::_('jgrid.published', $item->published, $i, 'cpcategorylist.', $canChange, 'cb'); ?>
				</td>
			</tr>
			<?php endforeach; ?>
		</tbody>
