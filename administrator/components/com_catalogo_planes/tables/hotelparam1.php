...
* @subpackage       catalogo_planes
*/
class TableHotelParam1 extends BasicTable {
    ...
    function check() {
        ...
        if (!$this->param1_name) {
            $this->setError(JText::_('CP.HOTELPARAM1_ERROR_EMPTY_NAME'));
            return false;
        }
        ...
        if ($id) {
            $this->setError(JText::_('CP.HOTELPARAM1_ERROR_DUPLICATE_NAME'));
            return false;
        }
