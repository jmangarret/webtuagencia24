...
* @subpackage		catalogo_planes
*/
class TablePlanCategory extends BasicTable {
	...
	function check() {
		...
		if (!$this->category_name) {
			$this->setError(JText::_('CP.PLANCATEGORY_ERROR_EMPTY_NAME'));
			return false;
		}
		...
		if ($id) {
			$this->setError(JText::_('CP.PLANCATEGORY_ERROR_DUPLICATE_NAME'));
			return false;
		}
