...
this.previewImage = function(){	
	...
	$current_body.append("<p id='preview'><img src='"+ this.href +"' alt='Image preview' height='350px' width='550px'/></p>"); //MICOD: anexado estilo height y width para el zoom de las imágenes de las habitaciones
	...
	jQuery("a.preview").hover(function(e){
		...
		var img = new Image( );
		img.src = this.href;
		height = 350; //MICOD: Importante, ajusta la posición que debe adoptar el zoom de las imágenes de las habitaciones
		
	    $preview.html("<img src='"+ this.href +"' alt='Image preview' height='350px' width='550px'/>");	//MICOD: anexado estilo height y width para el zoom de las imágenes de las habitaciones
