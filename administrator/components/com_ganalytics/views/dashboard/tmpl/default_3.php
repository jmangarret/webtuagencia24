...
<div id="dialog-group" class="gadialog" title="<?php echo JText::_('COM_GANALYTICS_DASHBOARD_VIEW_NEW_TAB_TITLE');?>" style="display: none;">
	<form>
		...
		<div class="fltrt">
			<button type="button" id="dialog-group-save" class="btn"><?php echo JText::_('JSAVE');?></button>
			<button type="button" id="dialog-group-cancel" class="btn"><?php echo JText::_('JCANCEL');?></button>
		</div>
	</form>
</div>
