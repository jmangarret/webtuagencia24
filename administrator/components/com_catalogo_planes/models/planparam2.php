 ...
 *
 * @version $Id: planparam2.php 2012-09-10 18:29:50 svn $
...
class CatalogoPlanesModelPlanParam2 extends CatalogoPlanesModelBasic {
	...
	function __construct() {
		...
		$this->_filter_prefix = $option . '_planparam2';
    }
    ...
    public function getRelatedProducts ($id) {
        $query = 'SELECT a.product_id, a.product_name FROM #__cp_plans_param2 b JOIN #__cp_plans_info a ' . 
