...
class CatalogoPlanesViewCarRate extends JView {
    ...
    function display ($tpl = null) {
        ...
        $product_link = '<a href="index.php?option=' . $option . '&view=cars&task=edit&cid[]=' . $this->product_id . '" class="product_link">' . $this->product_name . '</a>';
        if ($layout == 'form') {
            ...
            JToolBarHelper::divider();
            $bar->appendButton('Link', 'back', JText::_('CP.BACK'), 'index.php?option=' . $option . '&view=cars');
            JToolBarHelper::divider();
