<?php
/**
 * @version		3.1.112 administrator/components/com_j2xml/views/cpanel/tmpl/default.php
 * @package		J2XML
...
<table>
    <tr>
<?php if (version_compare(JPlatform::RELEASE, '12', 'lt')): ?>
...
<?php endif; ?>
		<td valign='top' style='padding: 7px 0 0 5px'>
			...
			$files = array(
				...
				JPATH_MANIFESTS.DS.'libraries'.DS.'filemanager.xml',
			);
