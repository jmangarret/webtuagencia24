 <script>
      ...
      var hotels = [
        ...
        foreach($hotels as $hotel){
        	...
        	'</p>'.
        	'<p><a href="'.$db->escape(JHotelUtil::getHotelLink($hotel)).'">'.JText::_('LNG_BOOK_HOTEL',true).'</a></p>'.
        	'</div>';
      ...
      function setMarkers(map, locations) {
		...
		var bounds = new google.maps.LatLngBounds();
         ...
         for (var i = 0; i < locations.length; i++) {
	          ...
	          var image = new google.maps.MarkerImage('<?php echo JURI::base() ."/components/com_jhotelreservation/assets/img/marker2.png"?>',
