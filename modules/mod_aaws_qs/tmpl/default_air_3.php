...
<form action="<?php echo JRoute::_(AawsHelperRoute::getFlowRoute('air.availability'), false); ?>" method="post" autocomplete="off">
  ...
  <div class="add-destiny" style="display: none;">
    <input type="button" value="<?php echo JText::_('MOD_AAWS_ADD_DESTINY'); ?>"/>
  </div>
  ...
  <div class="advanced">
    <div id="adv-title"><?php echo JText::_('MOD_AAWS_ADVANCED_OPTIONS'); ?></div>
    ...
    <div class="field">
      ...
      <div class="stops">
        <label id="stops-lbl" for="stops"><?php echo JText::_('MOD_AAWS_CONNECTIONS_LABEL'); ?></label>
        <?php echo JHTML::_('select.genericlist', $stops, AawsQsHelper::form('MAX_CONNECTIONS', false), '', 'value', 'text', '', 'stops'); ?>
      </div>
    </div>
  </div>

  <div class="button">
    <input type="submit" value="<?php echo JText::_('MOD_AAWS_SUBMIT_BUTTON'); ?>"/>
  </div>
