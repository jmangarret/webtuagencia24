...
class CatalogoPlanesViewSupplier extends JView {
	...
	function display ($tpl = null) {
		...
		if ($layout == 'form') {
			...
			// Obtiene título de la interfaz
			$title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.SUPPLIER');
		}
		// Agrega título de la plantilla
		JToolBarHelper::title($title, 'supplier.png');
