...
class CatalogoPlanesViewPlanParam1 extends JView {
	...
	function display ($tpl = null) {
		...
		if ($layout == 'form') {
			...
			$title .= ' ' . JText::_('CP.PLANPARAM1');

			// Agregar script para estrellas de hotel.
			...
			// Obtiene título de la interfaz
			$title = JText::_('CP.CATALOGOPLANES') . ' :: ' . JText::_('CP.PLANPARAM1');
		}
